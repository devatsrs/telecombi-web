                ...
                {                        // 9 Action
                    ...
                    mRender: function (id, type, full) {
                        ...
                        @if(User::checkCategoryPermission('Notification','Update'))
                                action += ' <a href="' + notification_edit_url.replace("{id}", id) + '" class="edit-notification btn btn-primary btn-sm tooltip-primary" data-original-title="Edit" title="" data-placement="top" data-toggle="tooltip"><i class="entypo-pencil"></i>&nbsp;</a>';
                        @endif
