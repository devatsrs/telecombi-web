...
<ol class="breadcrumb bc-3">
    ...
    <li class="active">
        <strong>Summary Reports By Prefix</strong>
    </li>
</ol>
<h3>Summary Reports By Prefix</h3>
            ...
            <div data-collapsed="0" class="card shadow card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                        <input type="text" name="Prefix" class="form-control" id="field-1" placeholder="" value="" />
                        </div>
...
var postdata;
    jQuery(document).ready(function ($) {
        ...
        $searchFilter.Prefix = $("#summer_filter [name='Prefix']").val();
        $searchFilter.CountryID = $("#summer_filter [name='CountryID']").val();
        data_table = $("#table-4").dataTable({
            ...
            "fnServerParams": function(aoData) {
                aoData.push({"name":"StartDate","value":$searchFilter.StartDate},{"name":"EndDate","value":$searchFilter.EndDate},{"name":"AccountID","value":$searchFilter.AccountID},{"name":"GatewayID","value":$searchFilter.GatewayID},{"name":"Prefix","value":$searchFilter.Prefix},{"name":"CountryID","value":$searchFilter.CountryID});
                data_table_extra_params.length = 0;
                data_table_extra_params.push({"name":"StartDate","value":$searchFilter.StartDate},{"name":"Export","value":1},{"name":"EndDate","value":$searchFilter.EndDate},{"name":"AccountID","value":$searchFilter.AccountID},{"name":"GatewayID","value":$searchFilter.GatewayID},{"name":"Prefix","value":$searchFilter.Prefix},{"name":"CountryID","value":$searchFilter.CountryID});
            },
             "aoColumns":
            [
