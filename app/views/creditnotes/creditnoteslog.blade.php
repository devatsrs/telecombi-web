...
<script type="text/javascript">
    var $searchFilter = {};
    var list_fields  = ['Notes','CreditNotesLogStatus','created_at','CreditNotesID'];
    var data_table_invoice_log;
    var creditnoteslogstatus = {{json_encode(CreditNotesLog::$log_status)}};
    jQuery(document).ready(function($) {
            ...
            data_table_invoice_log = $("#table-5").dataTable({
                ...
                "sAjaxSource": baseurl + "/creditnotes/ajax_creditnoteslog_datagrid/{{$id}}/type",
                ...
                "aoColumns":                        [
                            ...
                            {}, //note
                            {
                                mRender: function(status, type, full) {
                                    return creditnoteslogstatus[status];
                                }
                            }, // Status
                            {} // Date
                            ...
                            "aButtons": [
                                {
                                    "sExtends": "download",
                                    "sButtonText": "EXCEL",
                                    "sUrl": baseurl + "/creditnotes/ajax_creditnoteslog_datagrid/{{$id}}/xlsx",
                                    sButtonClass: "save-collection btn-sm"
                                },
                                {
                                    "sExtends": "download",
                                    "sButtonText": "CSV",
                                    "sUrl": baseurl + "/creditnotes/ajax_creditnoteslog_datagrid/{{$id}}/csv",
                                    sButtonClass: "save-collection btn-sm"
                                }
                            ]
                        },
