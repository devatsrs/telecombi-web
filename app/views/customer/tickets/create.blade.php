  ...
  <div class="col-md-12">
    <div class="card shadow card-primary" data-collapsed="0">
      <div class="card-header py-3">
        <div class="card-title"> @lang('routes.CUST_PANEL_PAGE_NEW_TICKET_DETAIL_HEADER') </div>
      ...
      <div class="card-body">
        <form role="form" id="form-tickets-add" method="post" action="{{URL::to('/customer/tickets/create')}}" class="form-horizontal form-groups-bordered">
          ...
          <p class="comment-box-options-activity"> <a id="addTtachment" class="btn-sm btn-primary btn-xs" title="@lang('routes.MESSAGE_ADD_AN_ATTACHMENT')" href="javascript:void(0)"> <i class="entypo-attach"></i> </a> </p>
