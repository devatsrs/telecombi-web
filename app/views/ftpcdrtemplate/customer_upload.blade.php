          ...
          <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body" id="mapping">
              ...
              <div class="form-group"> <br />
                ...
                <div class="col-sm-4"> {{Form::select('selection[Account]', array(),'',array("class"=>"select2 small"))}} </div>
                <label for=" field-1" class="col-sm-2 control-label">Cost</label>
                <div class="col-sm-4"> {{Form::select('selection[cost]', array(),'',array("class"=>"select2 small"))}} </div>
              </div>
              <div class="form-group"> <br />
                <br />
                ...
                <div class="col-sm-4"> {{Form::select('selection[is_inbound]',array(),'',array("class"=>"select2 small"))}} </div>
              </div>
              <div class="form-group"> <br />
                <br />
                <label for=" field-1" class="col-sm-2 control-label">Extension</label>
                <div class="col-sm-4"> {{Form::select('selection[extension]',array() ,'',array("class"=>"select2 small"))}} </div>
                <label for=" field-1" class="col-sm-2 control-label ">Area Prefix</label>
                <div class="col-sm-4"> {{Form::select('selection[Prefix]',array(),'',array("class"=>"select2 small"))}} </div>
              </div>
              <div class="form-group"> <br />
                <br />
                <label for=" field-1" class="col-sm-2 control-label">Trunk</label>
                <div class="col-sm-4"> {{Form::select('selection[Trunk]',array() ,'',array("class"=>"select2 small"))}} </div>
                <label for=" field-1" class="col-sm-2 control-label ">Pincode</label>
                <div class="col-sm-4"> {{Form::select('selection[Pincode]',array(),'',array("class"=>"select2 small"))}} </div>
              </div>
              <div class="form-group"> <br />
                <br />
    ...
    jQuery(document).ready(function ($) {
        ...
        $('#check_upload').click(function(e){
            ...
            $("#save_template").click(function(e){
                update_new_url = '{{URL::to('ftp_cdr_template/storeTemplate')}}';
                click_btn = $(this);
            });
