                   ...
                   "bSortable": true,
                    mRender: function ( id, type, full ) {
                        ...
                        view_url = baseurl + "/invoice_template/{id}/view";
                         ...
                         action += '</div>';
                        action += '&nbsp;<a  href="'+ view_url +'?Type=2" data-name = "'+full[0]+'" data-id="'+ id +'" data-original-title="Item View" title="" data-placement="top" data-toggle="tooltip" class="view-invoice_template btn btn-primary btn-sm tooltip-primary"><i class="entypo-list"></i></a>';
                        action += '&nbsp;<a  href="'+ view_url +'?Type=1" data-name = "'+full[0]+'" data-id="'+ id +'" data-original-title="Periodic View" title="" data-placement="top" data-toggle="tooltip" class="view-invoice_template btn btn-primary btn-sm tooltip-primary"><i class="entypo-calendar"></i></a>';
                        action += '&nbsp;<a  href="'+ view_url +'?Type=3" data-name = "'+full[0]+'" data-id="'+ id +'" data-original-title="Usage Column" title="" data-placement="top" data-toggle="tooltip" class="view-invoice_template btn btn-primary btn-sm tooltip-primary"><i class="entypo-doc-text"></i></a>';
                        action += '&nbsp;<a  href="'+ view_url +'?Type=4" data-name = "'+full[0]+'" data-id="'+ id +'" data-original-title="Management Reports" title="" data-placement="top" data-toggle="tooltip" class="view-invoice_template btn btn-primary btn-sm tooltip-primary"><i class="entypo-chart-bar"></i></a>';
                        <?php if(User::checkCategoryPermission('InvoiceTemplates','Edit') ){ ?>
                                action += ' <a data-name = "'+full[0]+'" data-id="'+ id +'" class="edit-invoice_template btn btn-primary btn-sm" data-original-title="Edit" title="" data-placement="top" data-toggle="tooltip" ><i class="entypo-pencil"></i></a>';
                        <?php } ?>
