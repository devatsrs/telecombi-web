...
class TimeZone extends \Eloquent {
    ...
    public static function getTimeZoneDropdownList() {
        ...
        self::clearCache();
        if ( Cache::has('tz_dropdown1_cache')) {
            $admin_defaults = Cache::get('tz_dropdown1_cache');
            self::$cache['tz_dropdown1_cache'] = $admin_defaults['tz_dropdown1_cache'];
        } else {
            $temp = array();
        ...
        self::$cache['tz_dropdown1_cache'] = array('' => cus_lang("DROPDOWN_OPTION_SELECT"))+ self::$cache['tz_dropdown1_cache'];

        return self::$cache['tz_dropdown1_cache'];

    }

    public static function clearCache(){

        Cache::flush("tz_dropdown1_cache");
