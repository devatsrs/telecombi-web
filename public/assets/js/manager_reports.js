...
function set_search_parameter(submit_form) {
  $searchFilter.StartDate = $(submit_form)
    .find("input[name='StartDate']")
    .val();
  $searchFilter.EndDate = $(submit_form)
        ...
        if (TotalCost) {
          $(
            $(row)
              .children()
              .get(2)
          ).html("<strong>" + TotalCost.toFixed(toFixed) + "</strong>");
        }
      } else {
        $(table_id)
          .find("tfoot")
        ...
        if (TotalMargin) {
          $(
            $(row)
              .children()
              .get(2)
          ).html("<strong>" + TotalMargin.toFixed(toFixed) + "</strong>");
        }
      } else {
        $(table_id)
          .find("tfoot")
