      ...
      drag: function(t, i) {
        ...
        for (d = p.snapElements.length - 1; d >= 0; d--)
          (o = p.snapElements[d].left),
            ...
            y > u + m ||
            !e.contains(
              p.snapElements[d].item.ownerDocument,
              ...
              ? (p.snapElements[d].snapping &&
                  ...
                  p.options.snap.release.call(
                    p.element,
                    t,
                    e.extend(p._uiHash(), { snapItem: p.snapElements[d].item })
                  ),
              ...
              : ("inner" !== f.snapMode &&
                ...
                "outer" !== f.snapMode &&
                  ...
                  n &&
                    (i.position.left =
                      p._convertPositionTo("relative", { top: 0, left: o })
                        .left - p.margins.left),
                  r &&
                    (i.position.left =
                      p._convertPositionTo("relative", {
  ...
  e.widget("ui.droppable", {
    ...
    (e.ui.intersect = function(e, i, a) {
      ...
      switch (a) {
        ...
        case "touch":
          return (
            ((l >= c && p >= l) || (h >= c && p >= h) || (c > l && h > p)) &&
            ((r >= u && d >= r) || (o >= u && d >= o) || (u > r && o > d))
          );
        default:
          return !1;
      }
        ...
        e: for (a = 0; n.length > a; a++)
          if (
            !(
              ...
              (t &&
                !n[a].accept.call(n[a].element[0], t.currentItem || t.element))
            )
          ) {
            ...
            (n[a].visible = "none" !== n[a].element.css("display")),
              n[a].visible &&
                ("mousedown" === r && n[a]._activate.call(n[a], i),
  ...
  e.widget("ui.resizable", e.ui.mouse, {
    ...
    _mouseStart: function(i) {
      ...
      return (
        ...
        r.containment &&
          ((s += e(r.containment).scrollLeft() || 0),
          (a += e(r.containment).scrollTop() || 0)),
        (this.offset = this.helper.offset()),
        (this.position = { left: s, top: a }),
        ...
        (this.originalSize = this._helper
          ? { width: h.outerWidth(), height: h.outerHeight() }
          : { width: h.width(), height: h.height() }),
        (this.originalPosition = { left: s, top: a }),
        (this.sizeDiff = {
    ...
    _mouseStop: function(t) {
      ...
      return (
        this._helper &&
          ...
          (r = { width: u.helper.width() - n, height: u.helper.height() - a }),
          (o =
          ...
          this.selectees.each(function() {
            ...
            i &&
              ...
              ("touch" === a.tolerance
                ...
                : "fit" === a.tolerance &&
                  (l = i.left > n && o > i.right && i.top > r && h > i.bottom),
              l
                ? (i.selected &&
        ...
        if (!e.contains(this.currentItem[0], this.containers[a].element[0]))
          if (this._intersectsWith(this.containers[a].containerCache)) {
            ...
            this.containers[a].containerCache.over &&
              (this.containers[a]._trigger("out", s, this._uiHash(this)),
      ...
      if (f)
        if (1 === this.containers.length)
          ...
          for (
            ...
            e.contains(this.containers[m].element[0], this.items[n].item[0]) &&
              ...
              ((c = this.items[n].item.offset()[h]),
              (d = !1),
              Math.abs(c - u) > Math.abs(c + this.items[n][l] - u) &&
                ((d = !0), (c += this.items[n][l])),
              r > Math.abs(c - u) &&
                ((r = Math.abs(c - u)),
                (o = this.items[n]),
...
(function(e) {
  ...
  (i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth =
    "hide"),
    (a.height = a.paddingTop = a.paddingBottom = a.borderTopWidth = a.borderBottomWidth =
      "show"),
    e.widget("ui.accordion", {
      ...
      _getCreateEventData: function() {
        return {
          header: this.active,
          card: this.active.length ? this.active.next() : e(),
                    ...
                    (i.now = Math.round(e)),
                      "height" !== i.prop
                        ...
                        : "content" !== h.options.heightStyle &&
                          ((i.now = Math.round(n - t.outerHeight() - l)),
                          (l = 0));
                  }
                }),
                undefined)
    ...
    _resetButton: function() {
      ...
      a.primary || a.secondary
        ? (this.options.text &&
            n.push(
              "ui-button-text-icon" +
                (s ? "s" : a.primary ? "-primary" : "-secondary")
            ),
          a.primary &&
            t.prepend(
  ...
  e.extend(i.prototype, {
        ...
        : ((r = a || {}),
          ...
          u &&
            ...
            null !== h &&
              r.dateFormat !== t &&
              r.minDate === t &&
              (u.settings.minDate = this._formatDate(u, h)),
            null !== l &&
              r.dateFormat !== t &&
              r.maxDate === t &&
      ...
      if (
        ...
        (i = e.datepicker._getInst(t)),
          ...
          n !== !1 &&
            ...
            i.inline ||
              ((h = e.datepicker._get(i, "showAnim")),
              (l = e.datepicker._get(i, "duration")),
              i.dpDiv.zIndex(e(t).zIndex() + 1),
              (e.datepicker._datepickerShowing = !0),
              e.effects && e.effects.effect[h]
                ? i.dpDiv.show(h, e.datepicker._get(i, "showOptions"), l)
    ...
    _checkOffset: function(t, i, a) {
      ...
      return (
        ...
        (i.left -= Math.min(
          i.left,
          i.left + s > h && h > s ? Math.abs(i.left + s - h) : 0
        )),
        (i.top -= Math.min(
          i.top,
    ...
    parseDate: function(i, a, s) {
        ...
        D = function(i, s, n) {
          ...
          if (
            (e.each(o, function(e, i) {
              var s = i[1];
              return a.substr(l, s.length).toLowerCase() === s.toLowerCase()
                ? ((r = i[0]), (l += s.length), !1)
                : t;
            }),
            -1 !== r)
      ...
      if (
        ((h = this._daylightSavingAdjust(new Date(g, v - 1, y))),
    ...
    _generateHTML: function(e) {
      ...
      for (
        e.drawMonth = Z,
          ...
          o = this._get(e, "gotoCurrent") && e.currentDay ? G : W,
          r = Q ? this.formatDate(r, o, this._getFormatConfig(e)) : r,
          h = e.inline
            ? ""
        ...
        for (D = "", this.maxRows = 4, w = 0; B[1] > w; w++) {
          ...
          for (
            S += N + "</tr></thead><tbody>",
              ...
              I = Math.ceil((P + A) / 7),
              F = U ? (this.maxRows > I ? this.maxRows : I) : I,
              this.maxRows = F,
              j = this._daylightSavingAdjust(new Date(et, Z, 1 - P)),
              H = 0;
            F > H;
            H++
          ) {
            for (
              ...
              (z = g ? g.apply(e.input ? e.input[0] : null, [j]) : [!0, ""]),
                (L = j.getMonth() !== Z),
                ...
                (E +=
                  ...
                  ((j.getTime() === T.getTime() &&
                    Z === e.selectedMonth &&
                    e._keyEvent) ||
                  (b.getTime() === j.getTime() && b.getTime() === T.getTime())
                    ? " " + this._dayOverClass
                    : "") +
                  (O
                  ...
                  (L && !v
                    ...
                    : "<a class='ui-state-default" +
                      (j.getTime() === W.getTime()
                        ? " ui-state-highlight"
                        : "") +
                      (j.getTime() === G.getTime() ? " ui-state-active" : "") +
        ...
        if (((e.yearshtml = ""), n || !v))
          ...
          for (
            d = this._get(e, "yearRange").split(":"),
              ...
              m = p(d[0]),
              f = Math.max(m, p(d[1] || "")),
              m = a ? Math.max(m, a.getFullYear()) : m,
...
(function(e, t) {
  ...
  e.widget("ui.tabs", {
    ...
    _getCreateEventData: function() {
      return {
        tab: this.active,
        card: this.active.length ? this._getPanelForTab(this.active) : e()
      };
    },
    ...
    _processTabs: function() {
      ...
      (this.tablist = this._getList()
        ...
        this.anchors.each(function(i, a) {
          ...
          s(a)
            ? ((n = a.hash), (r = t.element.find(t._sanitizeSelector(n))))
            : ((o = t._tabId(l)),
              (n = "#" + o),
              (r = t.element.find(n)),
              r.length ||
      ...
      this.xhr && this.xhr.abort(),
        ...
        this.tabs.add(this.panels).each(function() {
          e.data(this, "ui-tabs-destroy")
            ...
            : e(this)
                .removeClass(
                  "ui-state-default ui-state-active ui-state-disabled ui-corner-top ui-corner-bottom ui-widget-content ui-tabs-active ui-tabs-card"
                )
                .removeAttr("tabIndex")
...
(function(e) {
  e.effects.effect.fold = function(t, i) {
    ...
    e.effects.save(n, r),
      ...
      l && s.css(c ? { height: 0, width: u } : { height: u, width: 0 }),
      (g[f[0]] = l ? a[0] : u),
      (v[f[1]] = l ? a[1] : 0),
...
(function(e) {
  e.effects.effect.pulsate = function(t, i) {
    var s,
      ...
      p = c.length;
    for (
      (r || !a.is(":visible")) && (a.css("opacity", 0).show(), (d = 1)), s = 1;
      h > s;
      s++
    )
