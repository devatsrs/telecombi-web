...
(function() {
              ...
              try {
                document.addEventListener
                  ...
                  : document.attachEvent &&
                    ...
                    (document.detachEvent("onreadystatechange", b), e());
              } catch (a) {}
            }
            function e() {
  ...
  CKEDITOR.env ||
    (CKEDITOR.env = (function() {
      ...
      if (b.ie) {
        b.cssClass =
          b.cssClass +
          (" cke_browser_ie" + (b.quirks || b.version < 7 ? "6" : b.version));
    ...
    CKEDITOR.tools = {
      ...
      capitalize: function(b, a) {
        return (
          ...
          (a ? b.slice(1) : b.slice(1).toLowerCase())
        );
      },
      extend: function(b) {
        ...
        for (var d = 1; d < a; d++) {
          var n = arguments[d],
            j;
          for (j in n)
            if (e === true || b[j] == void 0) if (!f || j in f) b[j] = n[j];
        }
        return b;
      },
      ...
      cssStyleToDomStyle: (function() {
        var b = document.createElement("div").style,
          a =
            typeof b.cssFloat != "undefined"
              ? "cssFloat"
              : typeof b.styleFloat != "undefined"
              ? "styleFloat"
              : "float";
        return function(e) {
          return e == "float"
      ...
      normalizeCssText: function(a, c) {
        var e = [],
          f,
          d = CKEDITOR.tools.parseCssText(a, true, c);
      ...
      convertRgbToHex: function(a) {
        return a.replace(
          ...
          function(a, e, b, d) {
            a = [e, b, d];
            for (e = 0; e < 3; e++)
              a[e] = ("0" + parseInt(a[e], 10).toString(16)).slice(-2);
            return "#" + a.join("");
          }
        );
      },
  ...
  CKEDITOR.dtd = (function() {
    var a = CKEDITOR.tools.extend,
      d = function(a, e) {
        for (
          var b = CKEDITOR.tools.clone(a), f = 1;
          f < arguments.length;
          f++
        ) {
          var e = arguments[f],
        ...
        if (!this.hasListeners(a)) {
          ...
          if (c) {
            this.$.removeEventListener
              ? this.$.removeEventListener(a, c, false)
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getPreviousSourceNode: function(a, d, b) {
      ...
      return !a || (b && b(a) === false)
        ? null
        : d && a.type != d
        ? a.getPreviousSourceNode(false, d, b)
        : a;
    },
    ...
    getPosition: function(a) {
      ...
      if (
        ...
        if ("sourceIndex" in d)
          return d.sourceIndex < 0 || b.sourceIndex < 0
      ...
      for (
        var d = this.getAddress(),
          a = a.getAddress(),
          b = Math.min(d.length, a.length),
          c = 0;
        c <= b - 1;
        c++
      )
    ...
    rtrim: function() {
      ...
      if (CKEDITOR.env.needsBrFiller)
        (a = this.$.lastChild) &&
          a.type == 1 && a.nodeName.toLowerCase() == "br" &&
  ...
  (function() {
    ...
    function b(a) {
      for (var b = 0, d = 0, n = c[a].length; d < n; d++)
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      isEmptyInlineRemoveable: function() {
        ...
        for (var a = this.getChildren(), b = 0, c = a.count(); b < c; b++) {
          var d = a.getItem(b);
          if (
            !(d.type == CKEDITOR.NODE_ELEMENT && d.data("cke-bookmark")) &&
            ((d.type == CKEDITOR.NODE_ELEMENT &&
              !d.isEmptyInlineRemoveable()) ||
              (d.type == CKEDITOR.NODE_TEXT &&
                CKEDITOR.tools.trim(d.getText())))
          )
            return false;
        }
        return true;
      ...
      hasAttributes:
        CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)
          ...
          : function() {
              ...
              return (
                b > 0 &&
                (b > 2 || !c[a[0].nodeName] || (b == 2 && !c[a[1].nodeName]))
              );
            },
      ...
      mergeSiblings: (function() {
        function a(b, e, c) {
          if (e && e.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (b.isIdentical(e)) {
              for (var k = c ? b.getLast() : b.getFirst(); d.length; )
                d.shift().move(b, !c);
              e.moveChildren(b, !c);
              e.remove();
      ...
      unselectable: function() {
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera) {
          ...
          for (
            var a, b = this.getElementsByTag("*"), c = 0, d = b.count();
            c < d;
            c++
          ) {
            a = b.getItem(c);
      ...
      getDocumentPosition: function(a) {
        ...
        if (document.documentElement.getBoundingClientRect) {
          ...
          for (
            d = null;
            j && !(j.getName() == "body" || j.getName() == "html");
        ...
        if (a) {
          ...
          if (!j.equals(d) && j.$.frameElement) {
            a = new CKEDITOR.dom.element(j.$.frameElement).getDocumentPosition(
              a
            );
            b = b + a.x;
            c = c + a.y;
      ...
      scrollIntoParent: function(a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = g ? k.getBody() : k.getDocumentElement());
        k = a.getWindow();
        j = s(this, k);
        var r = s(a, k),
          w = this.$.offsetHeight;
        ...
        if (l < 0 || j > 0)
          u(0, b === true ? l : b === false ? j : l < 0 ? l : j);
      ...
      copyAttributes: function(a, b) {
        for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
          var j = c[d],
            ...
            l;
          if (!(k in b))
            if (k == "checked" && (l = this.getAttribute(k)))
              a.setAttribute(k, l);
            else if (
              j.specified ||
              (CKEDITOR.env.ie && j.nodeValue && k == "value")
            ) {
  ...
  (function() {
          ...
          g.type == CKEDITOR.NODE_ELEMENT &&
            (g =
              d > 0
                ...
                : i(g, true) === false
                ? null
                : g.getPreviousSourceNode(true, o, i));
        else {
          g = e;
          if (g.type == CKEDITOR.NODE_ELEMENT && !(g = g.getChild(l)))
            g = i(e, true) === false ? null : e.getNextSourceNode(true, o, i);
        }
        g && i(g) === false && (g = null);
      }
      for (; g && !this._.end; ) {
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function(a) {
      return this.getComputedStyle("float") == "none" &&
        !(this.getComputedStyle("position") in e) &&
        c[this.getComputedStyle("display")]
        ? true
    ...
    function a() {
      ...
      return function(g) {
        ...
        return (g.type == CKEDITOR.NODE_TEXT &&
          ...
          (g.type == CKEDITOR.NODE_ELEMENT && !g.is(f))
          ? false
          : true;
      };
    }
      ...
      e = function(a, b, c, e) {
        ...
        if (b == 2) {
          ...
          if (
            j &&
            p &&
            (g.$.parentNode != j.$.parentNode ||
              d.$.parentNode != p.$.parentNode)
          ) {
            b = p.getIndex();
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark2: (function() {
        function a(b) {
          ...
          var d = e;
          g =
            g.type != CKEDITOR.NODE_ELEMENT || d === 0 || d == g.getChildCount()
              ? 0
              : g.getChild(d - 1).type == CKEDITOR.NODE_TEXT &&
                g.getChild(d).type == CKEDITOR.NODE_TEXT;
          if (g) {
            c = c.getChild(e - 1);
            e = c.getLength();
          }
          c.type == CKEDITOR.NODE_ELEMENT &&
            e > 1 &&
            (e = c.getChild(e - 1).getIndex(true) + 1);
          if (c.type == CKEDITOR.NODE_TEXT) {
            g = c;
            for (d = 0; (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT; )
              d = d + g.getLength();
            e = e + d;
          }
          b.container = c;
      ...
      optimizeBookmark: function() {
        var a = this.startContainer,
          b = this.endContainer;
        a.is &&
          a.is("span") && a.data("cke-bookmark") &&
          this.setStartAt(a, CKEDITOR.POSITION_BEFORE_START);
        b &&
          b.is && b.is("span") && b.data("cke-bookmark") &&
      ...
      enlarge: function(a, b) {
        ...
        switch (a) {
                  ...
                  if (q.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (j && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                      ...
                      if (/[^\s\ufeff]/.test(k)) q = null;
                        ...
                        for (
                          var h = q.$.getElementsByTagName("*"), n = 0, C;
                          (C = h[n++]);
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var x,
              M,
              y = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              x,
              !x.is("br") &&
                ((!i && this.checkStartOfBlock()) || (i && x.contains(i)))
            ...
            this.setEndAt(
              x,
              (!i && this.checkEndOfBlock()) || (i && x.contains(i))
      ...
      shrink: function(a, b, c) {
        if (!this.collapsed) {
          ...
          if (g && g.type == CKEDITOR.NODE_TEXT)
            if (f)
              if (f >= g.getLength()) e.setStartAfter(g);
              else {
                e.setStartBefore(g);
                i = 0;
              }
          ...
          if (i)
            (g = e[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) &&
              this.setStartAt(
                g,
                b
                  ? CKEDITOR.POSITION_AFTER_START
      ...
      checkBoundaryOfElement: function(a, b) {
        var c = b == CKEDITOR.START,
          e = this.clone();
        e.collapse(c);
        e[c ? "setStartAt" : "setEndAt"](
          a,
          c ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_END
        );
        ...
        if (a.is(CKEDITOR.dtd.$block)) {
          if (
            ...
            if (
              ...
              d.getAttribute("contenteditable") == "false"
            ) {
    ...
    a.prototype = {
      getNextParagraph: function(a) {
        ...
        if (!this._.started) {
          ...
          h =
            g.endContainer.hasAscendant("pre", true) ||
            g.startContainer.hasAscendant("pre", true);
          g.enlarge(
          ...
          if (!g.collapsed) {
            ...
            if (
              ...
              if (r.checkEndOfBlock()) {
                ...
                this._.lastNode = (r.block || r.blockLimit).getNextSourceNode(
                  true
                );
              }
            }
        ...
        for (this._.nextNode = null; r; ) {
          ...
          if (i) r.type == CKEDITOR.NODE_TEXT && e.test(r.getText()) && (i = 0);
            ...
            if (
              ...
              r.isBlockBoundary(this.forceBrBreak && !m && { br: 1 })
            ) {
              if (o == "br") i = 1;
        ...
        if (!b) {
          ...
          if (
            ...
            this._.nextNode = b.equals(g)
              ? null
              : d(h.getBoundaryNodes().endNode, 1, g);
        }
        if (s)
          (s = b.getPrevious()) &&
            ...
            (s.getName() == "br"
              ? s.remove()
              : s.getLast() &&
                s.getLast().$.nodeName.toLowerCase() == "br" &&
                s.getLast().remove());
        if (t)
          (s = b.getLast()) &&
            s.type == CKEDITOR.NODE_ELEMENT &&
            s.getName() == "br" &&
            (!CKEDITOR.env.needsBrFiller || s.getPrevious(f) || s.getNext(f)) &&
            s.remove();
        if (!this._.nextNode)
          this._.nextNode = u || b.equals(g) || !g ? null : d(b, 1, g);
        return b;
      }
    };
  ...
  CKEDITOR.command = function(a, d) {
    ...
    this.refresh = function(a, b) {
      ...
      return this.fire("refresh", { editor: a, path: b }) === false
        ? true
        : d.refresh && d.refresh.apply(this, arguments) !== false;
    };
    var b;
    this.checkAllowed = function(c) {
      return !c && typeof b == "boolean"
        ? b
  ...
  (function() {
    function a(a, b, c, g, i) {
      var f = b.name;
      if (
        (g || typeof a.elements != "function" || a.elements(f)) &&
        (!a.match || a.match(b))
      ) {
        if ((g = !i)) {
          a: if (a.nothingRequired) g = true;
            ...
            g =
              ...
              e(b.attributes, a.requiredAttributes);
          }
          g = !g;
        }
        if (!g) {
    ...
    function t(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || o.$block[a.name])
      );
    }
    function g(a, b, c) {
      var e = a.name;
      if (o.$empty[e] || !a.children.length)
        ...
        if (b == "br") {
          ...
          if (d) {
            ...
            for (
              var g =
                  d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || d.name == "body",
                m,
                i = e.length;
              i > 0;
              ...
              if (
                ...
                (f.type == CKEDITOR.NODE_TEXT ||
                  (f.type == CKEDITOR.NODE_ELEMENT && o.$inline[f.name]))
              ) {
                if (!m) {
                ...
                d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  f.type == CKEDITOR.NODE_ELEMENT && !o[d.name][f.name] &&
    ...
    CKEDITOR.filter.prototype = {
      ...
      applyTo: function(a, b, e, d) {
          ...
          function(a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                e.children.length == 1 &&
                  (d = e.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  q(d, f, m, c, b);
                c = !c.length;
              }
              c || i.push(a);
        ...
        for (
          var r,
            a = [],
            d =
              E[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)];
          (e = i.pop());

        )
          e.type == CKEDITOR.NODE_ELEMENT ? g(e, d, a) : e.remove();
        for (; (r = a.pop()); ) {
          e = r.el;
          if (e.parent)
            switch (r.check) {
              case "it":
                o.$removeEmpty[e.name] && !e.children.length
                  ? g(e, d, a)
                  : l(e) || g(e, d, a);
                break;
              case "el-up":
                e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  !o[e.parent.name][e.name] &&
                  g(e, d, a);
                break;
              case "parent-down":
                e.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
      ...
      check: function(a, b, e) {
        ...
        b =
          o.length > 0
            ? false
            : CKEDITOR.tools.objectCompare(g.attributes, m.attributes, true)
            ? true
            : false;
  ...
  CKEDITOR.resourceManager.prototype = {
    add: function(a, d) {
      if (this.registered[a])
        throw '[CKEDITOR.resourceManager.add] The resource name "' +
          a +
    ...
    load: function(a, d, b) {
      ...
      for (
        var c = this.loaded, e = this.registered, f = [], h = {}, n = {}, j = 0;
        j < a.length;
        j++
      ) {
        var k = a[j];
            ...
            a.call(
              ...
              function(a) {
                ...
                for (l in a) {
                  ...
                  if (!d[l]) {
                    if (n.icons)
                      for (var t = n.icons.split(","), g = t.length; g--; )
  ...
  (function() {
    function a(a, c, f) {
      ...
      if (c !== void 0) {
        ...
        if (
          !(f == CKEDITOR.ELEMENT_MODE_INLINE
            ? c.is(CKEDITOR.dtd.$editable) || c.is("textarea")
            : f == CKEDITOR.ELEMENT_MODE_REPLACE
            ? !c.is(CKEDITOR.dtd.$nonBodyContent)
            : 1)
        )
          throw Error(
    ...
    function f(a) {
      ...
      if (c.fn) {
        ...
        (CKEDITOR.getUrl(a.config.customConfig) == b || !f(a)) &&
    ...
    function l(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function(c) {
        ...
        for (var f in c) {
          ...
          if (q && !a.lang[f]) {
            ...
            if (CKEDITOR.tools.indexOf(q, a.langCode) >= 0) h = a.langCode;
              ...
              h =
                h != a.langCode && CKEDITOR.tools.indexOf(q, h) >= 0
                  ? h
                  : CKEDITOR.tools.indexOf(q, "en") >= 0
                  ? "en"
                  : q[0];
            }
            if (!m.langEntries || !m.langEntries[h])
              i.push(CKEDITOR.getUrl(m.path + "lang/" + h + ".js"));
            else {
        ...
        CKEDITOR.scriptLoader.load(i, function() {
          for (
            var c = ["beforeInit", "init", "afterInit"], i = 0;
            i < c.length;
            i++
          )
            for (var f = 0; f < e.length; f++) {
              var m = e[f];
              i === 0 &&
                d[f] && m.lang && m.langEntries &&
                (a.lang[m.name] = m.langEntries[d[f]]);
              if (m[c[i]]) m[c[i]](a);
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      _attachToForm: function() {
        ...
        if (b.is("textarea") && c) {
          var e = function(c) {
            a.updateElement();
            a._.required &&
              !b.getValue() && a.fire("required") === false &&
      ...
      execCommand: function(a, b) {
        ...
        if (
          ...
          if (!c.async && this.fire("afterCommandExec", e) !== true)
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function(e, f, h) {
      ...
      var t = new CKEDITOR.htmlParser(),
        g =
          f instanceof CKEDITOR.htmlParser.element
            ? f
            : typeof f == "string"
            ? new CKEDITOR.htmlParser.element(f)
        ...
        if (a(g)) r.push(g);
          ...
          if (e == "br") w.push(g);
            ...
            for (;;) {
              h = (f = m.name)
                ? CKEDITOR.dtd[f] ||
                  (m._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : c;
              if (!g.isUnknown && !m.isUnknown && !h[e])
                if (m.isOptionalClose) t.onTagClose(f);
                  ...
                  ((f = f[f.length - 1]) && f.name == "li") ||
                    l((f = new CKEDITOR.htmlParser.element("li")), m);
                  !g.returnPoint && (g.returnPoint = m);
                  m = f;
                } else if (e in CKEDITOR.dtd.$listItem && !s(e, f))
                  t.onTagOpen(e == "li" ? "ul" : "dl", {}, 0, 1);
  ...
  (function() {
    ...
    a.prototype = {
      ...
      addMany: function(a, c, e) {
        for (var d = [this.findIndex(c), 0], h = 0, n = a.length; h < n; h++)
          d.push({ value: a[h], priority: c, options: e });
  ...
  (function() {
    function a(a, d) {
      ...
      function m(a, e) {
        return function(d) {
          if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            ...
            if (
              (i =
                (CKEDITOR.env.opera && !a) ||
                (typeof e == "function" ? e(d) !== false : e))
            )
              if (
                !t &&
                !CKEDITOR.env.needsBrFiller &&
      ...
      function q(a, b) {
        ...
        if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(w))) {
          ...
          if (!CKEDITOR.env.needsBrFiller && t && (!b || a.parent.name in v))
            return true;
          if (!t)
    ...
    function d(a, b) {
      return a != CKEDITOR.ENTER_BR && b !== false
    ...
    function f(a) {
      return (
        a &&
        ((a.type == CKEDITOR.NODE_ELEMENT && a.name in o) ||
    ...
    function t(a) {
      return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g, function(
        a,
        b
      ) {
        return decodeURIComponent(b);
    ...
    function r(a, b) {
      for (
        var c = [],
          ...
          d = b._.dataStore || (b._.dataStore = { id: 1 }),
          i = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g,
          e = [
      ...
      a = a.replace(i, function(a, b, e) {
        return (
          ...
          m +
          (b ? "{C}" : "") +
          encodeURIComponent(c[e]).replace(/--/g, "%2D%2D") +
          "-->"
        );
      });
      return a.replace(/(['"]).*?\1/g, function(a) {
        return a.replace(/<\!--\{cke_protected\}([\s\S]+?)--\>/g, function(
          a,
          b
        ) {
    ...
    CKEDITOR.htmlDataProcessor = function(b) {
      ...
      b.on(
        ...
        function(a) {
          ...
          c = u(c);
          c = t(c);
          a.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
            c,
            a.context,
            a.fixForBody === false
              ? false
  ...
  CKEDITOR.htmlParser.element = function(a, d) {
    ...
    b = !(
      ...
      !(CKEDITOR.dtd.$nonEditable[b] || b == "br")
    );
  ...
  (function() {
    ...
    CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(
      new CKEDITOR.htmlParser.node(),
      {
        ...
        setHtml: function(a) {
          for (
            var a = (this.children = CKEDITOR.htmlParser.fragment.fromHtml(
                a
              ).children),
              b = 0,
              d = a.length;
        ...
        getFilterContext: function(a) {
          ...
          !a.off &&
            this.attributes["data-cke-processor"] == "off" &&
            b.push("off", true);
          !a.nonEditable &&
  ...
  (function() {
    ...
    CKEDITOR.template = function(d) {
      if (a[d]) this.output = a[d];
        ...
        this.output = a[d] = Function(
          "data",
          "buffer",
          "return buffer?buffer.push('" + b + "'):['" + b + "'].join('');"
        );
      }
    };
  })();
  ...
  (function() {
    ...
    CKEDITOR.inlineAll = function() {
      ...
      for (b in CKEDITOR.dtd.$editable)
        for (
          var c = CKEDITOR.document.getElementsByTag(b), e = 0, f = c.count();
          e < f;
          e++
        ) {
          a = c.getItem(e);
  ...
  (function() {
    function a(a, c, h, n) {
      ...
      j.on("loaded", function() {
        ...
        n == CKEDITOR.ELEMENT_MODE_REPLACE &&
          j.config.autoUpdateElement && a.$.form &&
          j._attachToForm();
    ...
    function b(a) {
      var b = a.name,
        d = a.element,
        n = a.elementMode,
        j = a.fire("uiSpace", { space: "top", html: "" }).html,
      ...
      n &&
        a.ui.space("contents").setStyle("height", CKEDITOR.tools.cssLength(n));
    ...
    CKEDITOR.editor.prototype.resize = function(a, b, c, d) {
      ...
      k.setStyle(
        "height",
        Math.max(
          b - (c ? 0 : (d.$.offsetHeight || 0) - (k.$.clientHeight || 0)),
          0
        ) + "px"
      );
      l && (l.style.width = "100%");
  ...
  (function() {
    function a(a) {
      ...
      if (
        b.config.autoParagraph !== false &&
        b.activeEnterMode != CKEDITOR.ENTER_BR &&
        b.editable().equals(f) &&
        !e.block &&
        i.collapsed &&
        !i.getCommonAncestor().isReadOnly()
      ) {
        e = i.clone();
              ...
              if (c in m) {
                ...
                if ((e = f(e))) {
                  ...
                  if (
                    ...
                    g.blockLimit &&
                    g.blockLimit.is("td") &&
                    (j = g.blockLimit.getAscendant("table")) &&
                    b.checkBoundaryOfElement(
                      j,
                      c ? CKEDITOR.START : CKEDITOR.END
                    ) &&
                    (k = j[c ? "getPrevious" : "getNext"](l))
                  ) {
                    a.fire("saveSnapshot");
                    b["moveToElementEdit" + (c ? "End" : "Start")](k);
    ...
    var s = (function() {
      ...
      function e(b) {
        return (
          b &&
          a(b) &&
          (b.is(f.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
        );
      }
      function m(b, c, d, e) {
        var i = b.clone(),
        ...
        if (
          (g = new CKEDITOR.dom.walker(i).next()) &&
          a(g) &&
          h[g.getName()] &&
          (f = g.getPrevious()) &&
          a(f) &&
          !f.getParent().equals(b.startContainer) &&
          d.contains(f) &&
          e.contains(g) &&
          g.isIdentical(f)
        ) {
      ...
      return function(h, o, k) {
        ...
        if (!s.checkReadOnly()) {
          var y =
              new CKEDITOR.dom.elementPath(s.startContainer, s.root)
                .blockLimit || s.root,
            o = {
              type: o,
              dontFilter: u,
          ...
          if (
            o.type == "text" &&
            l.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)
          ) {
          ...
          if (!l.collapsed) {
            ...
            y &&
              !y.equals(X) && !y.contains(X) && l.checkEndOfBlock() &&
              o.zombies.push(y);
            l.deleteContents();
          }
          for (
            ...
            (z =
              a(l.startContainer) &&
              l.startContainer.getChild(l.startOffset - 1)) &&
            a(z) &&
            z.isBlockBoundary() &&
            D.contains(z);

          )
            l.moveToPosition(z, CKEDITOR.POSITION_BEFORE_END);
            ...
            for (i(D, G); v < D.length; v++) {
              ...
              if ((A = F.isLineBreak)) {
                ...
                if (F.hasBlockSibling) A = 1;
                  ...
                  if (!N || !N.is({ div: 1, p: 1 })) A = 0;
                  else {
                    U = N.getPosition(K);
                    if (
                      U == CKEDITOR.POSITION_IDENTICAL ||
                      U == CKEDITOR.POSITION_CONTAINS
                    )
                      A = 0;
                    else {
                      K = A.splitElement(N);
              ...
              if (A) u = v > 0;
                ...
                if (
                  !F.isBlock &&
                  o.editor.config.autoParagraph !== false &&
                  o.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                    o.editor.editable().equals(A.blockLimit) &&
                    !A.block &&
                  (P =
                    o.editor.activeEnterMode != CKEDITOR.ENTER_BR &&
                    o.editor.config.autoParagraph !== false
                      ? o.editor.activeEnterMode == CKEDITOR.ENTER_DIV
                        ? "div"
                        : "p"
                      : false)
                ) {
                ...
                if (F.lastNotAllowed && v < D.length - 1) {
                  (R = X ? y : R) &&
                    G.setEndAt(R, CKEDITOR.POSITION_AFTER_START);
                  l = 0;
                }
                G.collapse();
              }
          ...
          if (R)
            for (; (H = R.pop()); )
              CKEDITOR.env.needsBrFiller
                ? H.appendBogus()
                : H.append(J.document.createText(" "));
  ...
  (function() {
      ...
      return function(c) {
        ...
        if (b[d]) {
          ...
          if (e.length == 1 && g.collapsed)
            if (
              (d = g[
                d < 38 ? "getPreviousEditableNode" : "getNextEditableNode"
              ]()) &&
              d.type == CKEDITOR.NODE_ELEMENT &&
              d.getAttribute("contenteditable") == "false"
            ) {
    ...
    var l,
      u,
      s = CKEDITOR.dom.walker.invisible(1),
      t = (function() {
        function a(b) {
          return function(a) {
    ...
    CKEDITOR.on("instanceCreated", function(b) {
      ...
      e.on("contentDom", function() {
        ...
        i.attachListener(
          ...
          function() {
            l &&
              CKEDITOR.env.webkit &&
              (l =
                e._.previousActive && e._.previousActive.equals(b.getActive()));
            e.unlockSelection(l);
            l = 0;
          },
          null,
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera || j) {
          ...
          g
            ? i.attachListener(i, "beforedeactivate", s, null, null, -1)
            : i.attachListener(e, "selectionCheck", s, null, null, -1);
          i.attachListener(
            i,
              ...
              h.on("mousedown", function(a) {
                function b(a) {
                  ...
                  if (e) {
                    ...
                    e.setEndPoint(
                      g.compareEndPoints("StartToStart", c) < 0
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
            ...
            if (CKEDITOR.env.version > 7 && CKEDITOR.env.version < 11) {
              ...
              var v = function() {
                ...
                var a = CKEDITOR.document.$.selection,
                  d = a.createRange();
                a.type != "None" &&
                  d.parentElement().ownerDocument == b.$ &&
                  d.select();
              };
            }
          }
        ...
        if (
          j ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera
        ) {
          var D;
          i.attachListener(i, "mousedown", function() {
            D = 1;
          ...
          i.attachListener(
            CKEDITOR.env.ie ? i : b.getDocumentElement(),
            "mouseup",
            d,
            e
          );
        ...
        b.on(
          ...
          function() {
            var a = b.editable(),
              c = e(a);
            c &&
              (c.getCustomData("ready") ? f(a) : c.setCustomData("ready", 1));
          },
          null,
          null,
          -1
    ...
    CKEDITOR.editor.prototype.getSelection = function(a) {
      ...
      return (a = this.editable()) && this.mode == "wysiwyg"
    ...
    CKEDITOR.dom.selection = function(a) {
      ...
      if (CKEDITOR.env.webkit)
        ...
        if (g)
          b.type == "None" &&
            d && d.equals(this.document.getDocumentElement()) &&
            n(a, null, true);
        else {
          (b = b && b.anchorNode) && (b = new CKEDITOR.dom.node(b));
          d &&
            d.equals(this.document.getDocumentElement()) &&
              b &&
      ...
      if (d)
        if (d.getRangeAt)
          f =
            (h = d.rangeCount && d.getRangeAt(0)) &&
            new CKEDITOR.dom.node(h.commonAncestorContainer);
        else {
          try {
            h = d.createRange();
          } catch (j) {}
          f =
            ...
            CKEDITOR.dom.element.get(
              (h.item && h.item(0)) || h.parentElement()
            );
        }
      if (
        !f ||
                  ...
                  for (var d = [], e = 0; e < c.length; e++) {
                    for (
                      var i = c.item(e),
                        ...
                        f = 0,
                        a = new CKEDITOR.dom.range(this.root);
                      f < g.childNodes.length && g.childNodes[f] != i;
                      f++
                    );
              ...
              if (!g.collapsed) {
                if (g.startContainer.isReadOnly())
                  for (var b = g.startContainer, f; b; ) {
                    if (
                      ((f = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body")) ||
                      !b.isReadOnly()
                    )
                      break;
                    f &&
                ...
                f &&
                  f.type == CKEDITOR.NODE_TEXT &&
                  (j ? k.setEndAfter(f) : k.setEndBefore(f));
            ...
            if (g) {
              ...
              for (l = 0; l < a.length; l++) {
                ...
                if (
                  ...
                  if (
                    (!k && !d && j.is(CKEDITOR.dtd.$removeEmpty)) ||
    ...
    if (!b) {
      ...
      this.on("selectionChange", function(a) {
        for (var d = 0; d < b.length; d++) {
          var f = b[d],
            h = f.style.checkActive(a.data.path)
  ...
  (function() {
          ...
          if (o.equals(n)) {
            ...
            if (r && j && CKEDITOR.dtd.$block[s])
              for (
                var u = o,
                  ...
                  E = x.length,
                  I = 0,
                  u = E && new CKEDITOR.dom.range(u.getDocument());
                I < E;
                ++I
              ) {
                var B = x[I],
            ...
            x = s
              ? !k[s] || q
                ...
                ? 0
                : (o.getPosition(n) | M) == M &&
                  (!f.childRule || f.childRule(o))
              : 1;
            if (x)
              if (
                (x = o.getParent()) &&
                ((x.getDtd() || CKEDITOR.dtd.span)[g] || h) &&
                (!f.parentRule || f.parentRule(x))
              ) {
                if (
                  !p &&
                  (!s ||
                ...
                s = o.type;
                if (
                  s == CKEDITOR.NODE_TEXT ||
                  r ||
                  (s == CKEDITOR.NODE_ELEMENT && !o.getChildCount())
                ) {
                  for (
                    var s = o, W;
                    (i = !s.getNext(C)) &&
                    ((W = s.getParent()), k[W.getName()]) &&
                    (W.getPosition(m) | y) == y &&
                    (!f.childRule || f.childRule(W));
            ...
            for (
              ...
              if (q.getName() == g) {
                for (T in f.attributes)
                  if (!E[T] && (Z = q.getAttribute(Q)))
                    i.getAttribute(T) == Z ? (x[T] = 1) : (E[T] = 1);
                for (Q in f.styles)
                  if (!B[Q] && (Z = q.getStyle(Q)))
                    i.getStyle(Q) == Z ? (s[Q] = 1) : (B[Q] = 1);
              }
              q = q.getParent();
            }
      ...
      if (a.collapsed) {
        for (
          var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root),
            ...
            h = 0,
            i;
          h < e.elements.length && (i = e.elements[h]);
          h++
        ) {
          ...
          if (this.checkElementRemovable(i)) {
            ...
            if (
              a.collapsed &&
              (a.checkBoundaryOfElement(i, CKEDITOR.END) ||
                (j = a.checkBoundaryOfElement(i, CKEDITOR.START)))
            ) {
              f = i;
              f.match = j ? "start" : "end";
            } else {
    ...
    function s(a) {
      ...
      for (var h in b)
        if (
          !(this._.definition.fullMatch && a.getStyle(h) != o(h, b[h], true))
        ) {
          e = e || !!a.getStyle(h);
          a.removeStyle(h);
        }
    ...
    function t(a) {
      for (
        var b = q(this), c = a.getElementsByTag(this.element), d, e = c.count();
        --e >= 0;
      ...
      if (!a.hasAttributes() || b)
        if (CKEDITOR.dtd.$block[a.getName()]) {
          ...
          if (c) {
            ...
            d &&
              !c.equals(d) && d.type == CKEDITOR.NODE_ELEMENT &&
              d.mergeSiblings();
          }
        }
    }
    ...
    function i(a, b) {
      for (var c in a)
        a[c] = a[c].replace(I, function(a, c) {
          return b[c];
        });
    }
    function q(a) {
    ...
    CKEDITOR.editor.prototype.removeStyle = function(a) {
      a.checkApplicable(this.elementPath()) &&
        ...
        if (c) {
          ...
          for (var e = 0; e < c.length; e++) {
            ...
            if ((d = a.getAttribute(d))) {
              var g = c[e][1];
              if (g === null || (typeof g == "string" && d == g) || g.test(d))
                return true;
            }
          }
        }
      ...
      do
        if (j.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if (!this.lastElement) {
            this.lastElement = j;
            if (
              j.is(CKEDITOR.dtd.$object) ||
              j.getAttribute("contenteditable") == "false"
            )
              continue;
          }
          if (j.equals(e)) break;
          if (!h) {
            k = j.getName();
            j.getAttribute("contenteditable") == "true"
              ? (h = j)
              : !f && d[k] && (f = j);
            if (a[k]) {
              var l;
              ...
              if (h)
                for (var k = 0; a[f + k + 1]; ) {
                  for (
                    var l = n.document,
                      h = 0,
                      j = l.getById(d[k].endNode),
                      l = l.getById(d[k + 1].startNode);
                    ;
                    ...
                    if (l.equals(j)) h = 1;
                      ...
                      c(j) ||
                      (j.type == CKEDITOR.NODE_ELEMENT && j.isBlockBoundary())
                    )
                      continue;
                    break;
                  }
      ...
      for (var f = 0; f < a.length; f++)
        if (CKEDITOR.env.webkit)
          ...
          CKEDITOR.env.ie && CKEDITOR.env.version < 11
            ? (a[f].$.styleSheet.cssText = a[f].$.styleSheet.cssText + g)
            : (a[f].$.innerHTML = a[f].$.innerHTML + g);
        }
    }
    var f = {};
    CKEDITOR.skin = {
        ...
        var b = a.editor,
          a = function(a) {
            ...
            if (!a.getById("cke_ui_color")) {
              ...
              n.push(a);
              var d = b.getUiColor();
              d && e([a], CKEDITOR.skin.chameleon(b, "card"), [[j, d]]);
            }
          };
        b.on("panelShow", a);
        b.on("menuShow", a);
  ...
  (function() {
    if (CKEDITOR.env.webkit) CKEDITOR.env.hc = false;
      ...
      try {
        CKEDITOR.env.hc =
          a.getComputedStyle("border-top-color") ==
          a.getComputedStyle("border-right-color");
      } catch (d) {
...
*/
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function() {
                for (
                  ...
                  e.push(
                    new CKEDITOR.ui.dialog.uiElement(b, m, q, "input", null, o)
                  );
                  q.push(" ");
      ...
      CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
        ...
        n,
        {
          ...
          reset: function() {
            ...
            f ||
              ((f = this.formLoadedNumber = CKEDITOR.tools.addFunction(
                function() {
                  this.fire("formLoaded");
                },
                this
              )),
              (h = this.formUnloadNumber = CKEDITOR.tools.addFunction(
                function() {
    ...
    function U(a) {
      function b(b) {
        ...
        a.move(
          d.x + i[3] < f
            ? -i[3]
            : d.x - i[1] > h.width - c.width - f
            ? h.width - c.width + ("rtl" == g.lang.dir ? 0 : i[1])
            : d.x,
          d.y + i[0] < f
            ? -i[0]
            : d.y - i[2] > h.height - c.height - f
            ? h.height - c.height + i[2]
            : d.y,
          1
        );
        b.data.preventDefault();
        ...
        a.on("load", function() {
          ...
          b = CKEDITOR.dom.element.createFromHtml(
            '<div class="cke_resizer' +
              ...
              i.lang.dir +
              '" title="' +
              CKEDITOR.tools.htmlEncode(i.lang.common.resize) +
    ...
    CKEDITOR.dialog.prototype = {
          ...
          if (b.contents[e]) {
            ...
            if (d) {
              for (var i in this._.contents[a.id]) {
                ...
                "hbox" == l.type ||
                  "vbox" == l.type || !l.getInputElement() ||
                  (l.requiredContent &&
                  !this._.editor.activeFilter.check(l.requiredContent)
                    ? l.disable()
                    : (l.enable(), f++));
              }
      ...
      addPage: function(a) {
        if (
          ...
          for (
            ...
            !e.notAllowed && "hbox" != e.type && "vbox" != e.type && f++,
              (d[e.id] = e),
      ...
      hidePage: function(a) {
        ...
        b &&
          ...
          (a == this._.currentTabId && this.selectPage(t.call(this)),
          b.hide(),
          this._.pageCount--,
          this.updateStyle());
      },
        ...
        uiElement: function(a, b, c, e, d, g, f) {
          if (!(4 > arguments.length)) {
            ...
            b.requiredContent &&
              ...
              ((k.display = "none"), (this.notAllowed = !0));
            h.id = j;
            var n = {};
            ...
            b.align &&
              ((m = b.align),
              (k["margin-left"] = "left" == m ? 0 : "auto"),
              (k["margin-right"] = "right" == m ? 0 : "auto"));
            ...
            this.accessKeyUp &&
              this.accessKeyDown && b.accessKey &&
            ...
            CKEDITOR.ui.dialog.uiElement.call(
              ...
              function() {
                ...
                for (var e = 0; e < c.length; e++) {
                  ...
                  CKEDITOR.env.ie &&
                    CKEDITOR.env.quirks && g[e].align &&
                    h.push("text-align:" + g[e].align);
  ...
  (function() {
    function w(b) {
        ...
        CKEDITOR.env.ie &&
          e.on("paste", function(e) {
            r ||
              ...
              u(e),
              l("paste") || b.openDialog("paste"));
          });
        CKEDITOR.env.ie &&
          (e.on("contextmenu", h, null, null, 0),
          e.on(
            "beforepaste",
            function(b) {
      ...
      function i() {
        if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
          var e = b.getSelection(),
            ...
            c;
          if (
            e.getType() == CKEDITOR.SELECTION_ELEMENT &&
      ...
      function k(a, d) {
        ...
        if (!c.getById("cke_pastebin")) {
          ...
          var g = 0,
            c = c.getWindow();
          f
            ? (j.insertAfter(v[0].startNode), j.setStyle("display", "inline"))
            : (CKEDITOR.env.webkit
                ? (i.append(j),
                  j.addClass("cke_editable"),
                  i.is("body") ||
                    ((f =
                      "static" != i.getComputedStyle("position")
                        ? i
      ...
      b.getClipboardData = function(a, d) {
        ...
        !1 === o() &&
          (b.removeListener("paste", c),
          k && b.fire("pasteDialog", f)
            ? (b.on("pasteDialogCommit", i),
        ...
        b.on(
          ...
          function(c) {
            var c = c.data,
              ...
              f = c.dataValue,
              h,
              l = b.config.clipboard_defaultContentType || "html";
            h = "html" == d || "html" == c.preSniffing ? "html" : x(f);
            "htmlifiedtext" == h
              ? (f = y(b.config, f))
              : "text" == d &&
                "html" == h &&
                (f = A(b.config, f, a || (a = z(b))));
  ...
  (function() {
    CKEDITOR.plugins.add("card", {
      beforeInit: function(a) {
        a.ui.addHandler(CKEDITOR.UI_PANEL, CKEDITOR.ui.card.handler);
      }
    });
    CKEDITOR.UI_PANEL = "card";
    CKEDITOR.ui.card = function(a, b) {
    ...
    CKEDITOR.ui.card.handler = {
      create: function(a) {
        return new CKEDITOR.ui.card(a);
      }
    };
    ...
    CKEDITOR.ui.card.prototype = {
      ...
      addBlock: function(a, b) {
        b = this._.blocks[a] =
          b instanceof CKEDITOR.ui.card.block
            ? b
            : new CKEDITOR.ui.card.block(this.getHolderElement(), b);
    ...
    CKEDITOR.ui.card.block = CKEDITOR.tools.createClass({
      $: function(a, b) {
  ...
  CKEDITOR.plugins.add("floatpanel", { requires: "card" });
  (function() {
    function q(a, b, c, i, f) {
      var f = CKEDITOR.tools.genKey(
          b.getUniqueId(),
          c.getUniqueId(),
          a.lang.dir,
          a.uiColor || "",
        ...
        h = g[f];
      h ||
        ((h = g[f] = new CKEDITOR.ui.card(b, i)),
        (h.element = c.append(
          CKEDITOR.dom.element.createFromHtml(h.render(a), b)
        )),
    ...
    CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
      ...
      proto: {
        addBlock: function(a, b) {
          return this._.card.addBlock(a, b);
        },
        addListBlock: function(a, b) {
          return this._.card.addListBlock(a, b);
        },
        getBlock: function(a) {
          return this._.card.getBlock(a);
        },
        showBlock: function(a, b, c, i, f, h) {
          ...
          this._.card._.offsetParentId = b.getId();
              ...
              var a = CKEDITOR.tools.bind(function() {
                ...
                if (l.autoSize) {
                  var a = l.element.getDocument(),
                    a = (CKEDITOR.env.webkit ? l.element : a.getBody()).$
                      .scrollWidth;
                  CKEDITOR.env.ie &&
                ...
                if (CKEDITOR.env.ie) {
                  ...
                  b.getComputedStyle("direction") == "rtl" &&
                    (e = CKEDITOR.env.ie8Compat
                      ? e -
                        d.getDocument().getDocumentElement().$.scrollLeft * 2
                      : e - (a.$.scrollWidth - a.$.clientWidth));
                }
                var a = d.getFirst(),
                  n;
                (n = a.getCustomData("activePanel")) &&
                  n.onHide &&
        ...
        showAsChild: function(a, b, c, g, f, h) {
          (this._.activeChild == a && a._.card._.offsetParentId == c.getId()) ||
            (this.hideChild(),
  ...
  (function() {
    ...
    CKEDITOR.menu = CKEDITOR.tools.createClass({
      $: function(a, b) {
        ...
        var c = CKEDITOR.tools.extend({}, b.card, {
      ...
      _: {
        ...
        onEscape: function(a) {
          var b = this.parent;
          b ? b._.card.hideChild(1) : 27 == a && this.hide(1);
          return !1;
        },
        onHide: function() {
      ...
      proto: {
        ...
        show: function(a, b, c, j) {
          ...
          var b = b || ("rtl" == this.editor.lang.dir ? 2 : 1),
            ...
            h = this._.element;
          if (!f) {
            f = this._.card = new CKEDITOR.ui.floatPanel(
              this.editor,
          ...
          CKEDITOR.ui.fire("ready", this);
          this.parent
            ? this.parent._.card.showAsChild(f, this.id, a, b, c, j)
        ...
        hide: function(a) {
          this._.onHide && this._.onHide();
          this._.card && this._.card.hide(a);
        }
      }
    });
      ...
      var t = CKEDITOR.tools.addFunction(j),
        u = CKEDITOR.tools.addFunction(function(d, e) {
          ...
          switch (e.getKeystroke()) {
            ...
            case 9:
              return (
                (b = CKEDITOR.document.getById(g + (d + 1))) ||
            ...
            case CKEDITOR.SHIFT + 9:
              return (
                (b = CKEDITOR.document.getById(g + (d - 1))) ||
                  (b = CKEDITOR.document.getById(g + (i.list.length - 1))),
                b.focus(),
                !1
              );
            case 27:
  ...
  (function() {
    function j(a, b) {
      var d = {},
        ...
        a = a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g, function(
          a,
          h
        ) {
          var c = b ? "&" + h + ";" : f[h];
  ...
  CKEDITOR.plugins.add("listblock", {
    ...
    onLoad: function() {
      ...
      CKEDITOR.ui.card.prototype.addListBlock = function(a, b) {
            ...
            d = {
              ...
              execute: function(d) {
                ...
                if (b.state != CKEDITOR.TRISTATE_DISABLED)
                  if ((f.createPanel(a), b.on)) b.card.hide();
                  else {
                    f.commit();
                    var c = f.getValue();
                    c ? b.list.mark(c) : b.list.unmarkAll();
                    b.card.showBlock(f.id, new CKEDITOR.dom.element(d), 4);
                  }
              },
              clickFn: e
            };
  ...
  CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
    ...
    proto: {
      openTag: function(b) {
        ...
        this._.afterCloser &&
          a && a.needsSpace && this._.needsSpace &&
          this._.output.push("\n");
        this._.indent
          ? this.indentation()
        ...
        setData: function(a, d) {
          ...
          if (d) this.setHtml(a), b.fire("dataReady");
            ...
            CKEDITOR.env.ie &&
              ...
              (c +=
                '<script id="cke_shimscrpt">window.parent.CKEDITOR.tools.enableHtml5Elements(document)</script>');
    ...
    CKEDITOR.plugins.add("image", {
      ...
      init: function(b) {
        ...
        b.on("doubleclick", function(a) {
          ...
          b.is("img") &&
            !b.data("cke-realelement") && !b.isReadOnly() &&
            (a.data.dialog = "image");
        });
        b.addMenuItems &&
          b.addMenuItems({
  ...
  (function() {
    ...
    CKEDITOR.plugins.indent.specificDefinition.prototype = {
      ...
      refreshJob: function(a, b, e) {
        b = this.jobs[b];
        b.state = a.activeFilter.checkFeature(this)
          ? b.refresh.call(this, a, e)
          : i;
        return b.state;
      },
    ...
    function s(e) {
      ...
      for (
        var n = this,
          ...
          k = this.context,
          l = e.getSelection(),
          l = (l && l.getRanges()).createIterator(),
          d;
        (d = l.getNextRange());
        ...
        if (!b) {
          ...
          c &&
            c.type == CKEDITOR.NODE_ELEMENT && c.getName() in k &&
      ...
      var a =
        ...
        d =
          ...
          (CKEDITOR.plugins.link.synAnchorSelector
            ? "a.cke_anchor_empty{display:inline-block;}"
            : "") +
          ".%2 img.cke_anchor{" +
          a +
  ...
  (function() {
    function E(c, k, e) {
      function b(b) {
        if (
          ...
          (m = k.root[b ? "getPrevious" : "getNext"](
      ...
      for (
        var j = CKEDITOR.plugins.list.listToArray(k.root, e), g = [], h = 0;
        h < k.contents.length;
        h++
      ) {
        var f = k.contents[h];
        if (
          (f = f.getAscendant("li", !0)) &&
          !f.getCustomData("list_item_processed")
        )
          g.push(f),
    ...
    function A(c, k, e, b) {
      for (var j, g; (j = c[b ? "getLast" : "getFirst"](F)); )
        (g = j.getDirection(1)) !== k.getDirection(1) &&
          j.setAttribute("dir", g),
          j.remove(),
    ...
    function B(c) {
      ...
      (k = function(e) {
        ...
        b &&
          b.type == CKEDITOR.NODE_ELEMENT && b.is(c.getName()) &&
          (A(c, b, null, !e), c.remove(), (c = b));
      })();
      k(1);
    }
    function C(c) {
    ...
    function y(c, k, e) {
      ...
      h
        ...
        : f && (h = f.getPrevious(q)) && v(h) && h.remove();
      (h = b.getLast()) &&
        h.type == CKEDITOR.NODE_ELEMENT && h.is("br") &&
        h.remove();
      (h = k.startContainer.getChild(k.startOffset))
        ? b.insertBefore(h)
        : k.startContainer.append(b);
      if (a && (b = w(a)))
      ...
      for (; e.checkStartOfBlock() && e.checkEndOfBlock(); )
        (f = e.startPath()),
          ...
          b.is("li") &&
            ((g = b.getParent()),
            b.equals(g.getLast(q)) && b.equals(g.getFirst(q)) && (b = g)),
      ...
      (e = e.next()) &&
        e.type == CKEDITOR.NODE_ELEMENT && e.getName() in CKEDITOR.dtd.$list &&
        B(e);
      k.moveToBookmark(j);
      k.select();
      c.fire("saveSnapshot");
    ...
    CKEDITOR.plugins.list = {
      listToArray: function(c, k, e, b, j) {
        ...
        for (var g = 0, h = c.getChildCount(); g < h; g++) {
          ...
          f.type == CKEDITOR.NODE_ELEMENT &&
            ...
            CKEDITOR.plugins.list.listToArray(f, k, e, b + 1);
          if ("li" == f.$.nodeName.toLowerCase()) {
            ...
            k &&
              CKEDITOR.dom.element.setMarker(k, f, "listarray_index", e.length);
            e.push(a);
            for (var d = 0, m = f.getChildCount(), i; d < m; d++)
              (i = f.getChild(d)),
                i.type == CKEDITOR.NODE_ELEMENT && r[i.getName()]
      ...
      arrayToList: function(c, k, e, b, j) {
        ...
        for (
          var g,
            h = c[e].parent.getDocument(),
            f = new CKEDITOR.dom.documentFragment(h),
            a = null,
            d = e,
            m = Math.max(c[e].indent, 0),
            i = null,
            n,
            l,
          ...
          if (o.indent == m) {
            ...
            (o = c[d - 1].element.getDirection(1)),
              ...
              !i.getChildCount() &&
                CKEDITOR.env.needsNbspFiller && !(7 < h.$.documentMode) &&
                i.append(h.createText(" ")),
              i.append(d.listNode),
              (d = d.nextIndex);
          else if (-1 == o.indent && !e && g) {
            r[g.getName()]
              ? ((i = o.element.clone(!1, !0)),
                n != g.getDirection(1) && i.setAttribute("dir", n))
              : (i = new CKEDITOR.dom.documentFragment(h));
              ...
              if (((s = o.contents[g]), D(s) && 1 < x))
                ...
                w
                  ? (l ||
                      ((l = h.createElement(p)),
                      i.append(l),
                      a && l.setAttribute("dir", n)),
                    v && l.setAttribute("style", v),
                    z && l.setAttribute("class", z),
                    t && (l.append(t), (t = null)),
                    l.append(s.clone(1, 1)))
                  : i.append(s.clone(1, 1));
            ...
            i.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
              ...
              (CKEDITOR.env.needsBrFiller &&
                (n = i.getLast()) &&
                n.type == CKEDITOR.NODE_ELEMENT && n.is("br") &&
                n.remove(),
              (n = i.getLast(q)),
              (!n ||
                !(
                  n.type == CKEDITOR.NODE_ELEMENT && n.is(CKEDITOR.dtd.$block)
                )) &&
                i.append(h.createElement("br")));
        ...
        if (k)
          for (c = f.getFirst(); c; ) {
            if (
              c.type == CKEDITOR.NODE_ELEMENT &&
              (CKEDITOR.dom.element.clearMarkers(k, c),
              c.getName() in CKEDITOR.dtd.$listItem &&
                ((e = c), (h = j = b = void 0), (b = e.getDirection())))
            ) {
      ...
      exec: function(c) {
        ...
        if (this.state == CKEDITOR.TRISTATE_OFF) {
          ...
          if (j.getFirst(q)) {
            ...
            (k = g && g.getEnclosedNode()) &&
              k.is && this.type == k.getName() &&
              this.setState(CKEDITOR.TRISTATE_ON);
          } else
            k.enterMode == CKEDITOR.ENTER_BR
              ? j.appendBogus()
              : b[0].fixBlock(1, k.enterMode == CKEDITOR.ENTER_P ? "p" : "div"),
              e.selectRanges(b);
        }
        for (
          var k = e.createBookmarks(!0),
            j = [],
            h = {},
            b = b.createIterator(),
            f = 0;
          ...
          d.type == CKEDITOR.NODE_ELEMENT &&
            "td" == d.getName() &&
            g.setStartAt(a.startNode, CKEDITOR.POSITION_AFTER_START);
          m.type == CKEDITOR.NODE_ELEMENT &&
            "td" == m.getName() &&
            g.setEndAt(a.endNode, CKEDITOR.POSITION_BEFORE_END);
          g = g.createIterator();
          for (
            ...
            if (!a.getCustomData("list_block")) {
              ...
              m ||
                ((m = i),
                m.getCustomData("list_group_object_" + f)
                  ? m.getCustomData("list_group_object_" + f).contents.push(a)
                  : ((d = { root: m, contents: [a] }),
                    CKEDITOR.dom.element.setMarker(
                      h,
                      m,
                      "list_group_object_" + f,
                      d
                    ),
                    j.push(d)));
            }
        ...
        for (n = []; 0 < j.length; )
          if (((d = j.shift()), this.state == CKEDITOR.TRISTATE_OFF))
            if (r[d.root.getName()]) {
              ...
              for (
                var l = f.root.getDocument(), p = void 0, o = void 0, a = 0;
                a < i.length;
                a++
              ) {
              ...
              1 == i.length &&
                ...
                i[0].moveChildren && i[0].moveChildren(d),
                i[0].append(d),
                (i[0] = d));
              ...
              if (b && b.collapsed) {
                ...
                if (g) {
                  ...
                  if (d) {
                    ...
                    (e = j.contains(r)) &&
                    b.checkBoundaryOfElement(e, CKEDITOR.START)
                  ) {
                    d = e.getFirst(q);
  ...
  (function() {
      ...
      q(d, {
        ...
        place: function() {
          ...
          h && g
            ...
            : h
            ? g || (k.top = h.size.bottom + h.size.margin.bottom)
      ...
      d.lineChildren[0].on("mouseup", function(b) {
        ...
        N(
          ...
          function(b) {
            ...
            b[c.is(D) ? "insertBefore" : "insertAfter"](
              c.is(D) ? c.lower : c.upper
            );
          },
          !0
        );
    ...
    function N(a, c, d) {
      ...
      n.ie && a.enterMode == CKEDITOR.ENTER_BR
        ...
        : ((f =
            ((f = K(a.element, !0)) && f.data("cke-enter-mode")) ||
            a.enterMode),
          (f = new M(F[f], a.doc)),
          f.is("br") || a.doc.createText(E).appendTo(f));
        ...
        exec: (function() {
          ...
          return function(b) {
            ...
            if (
              ...
              e.is(a.triggers) &&
              e.is(ia) &&
              (!r(a, e, !c) || ((f = r(a, e, !c)) && m(f) && f.is(a.triggers)))
                ? d(e)
                : ((f = J(a, b)),
                  m(f) &&
                    (r(a, f, !c)
                      ? (b = r(a, f, !c)) && m(b) && b.is(a.triggers) && d(f)
                      : d(f)));
            }
          };
        })()
    ...
    function Y(a) {
      ...
      o(a, c);
      return !f && 0 <= c.size.top && 0 < d.y && d.y < c.size.top + e
        ? ((a = a.inInlineMode || 0 === b.scroll.y ? x : s),
          new u([null, c, D, H, a]))
        : f &&
        ...
        ? ((a =
            a.inInlineMode ||
            (c.size.bottom > b.pane.height - e && c.size.bottom < b.pane.height)
              ? y
              : s),
          new u([c, null, Z, H, a]))
        : null;
      ...
      if (g) {
        ...
        e.equals(a.editable[h ? "getLast" : "getFirst"](a.isRelevant))
          ? (C(a),
            ...
            c.y > e.size.bottom - b &&
            c.y < d.pane.height &&
            e.size.bottom > d.pane.height - b &&
            e.size.bottom < d.pane.height
              ? (i = y)
              : 0 < c.y && c.y < e.size.top + b && (i = x))
          : (i = s),
          (f = [null, e]
            [h ? "reverse" : "concat"]()
            .concat([
    ...
    function P(a, c, d, b) {
      for (
        ...
        (i[t[l]] = parseInt(e("border-" + t[l] + "-width"), 10) || 0),
          (g[t[l]] = parseInt(e("padding-" + t[l]), 10) || 0),
          (h[t[l]] = parseInt(e("margin-" + t[l]), 10) || 0);
      (!d || b) && I(a, b);
      ...
      a.inInlineMode &&
        (j.scroll = { top: c.$.scrollTop, left: c.$.scrollLeft });
        ...
        a.on(
          ...
          function() {
            ...
            d.is(w.$inline) ||
                ...
                if (!("wysiwyg" != a.mode || a.readOnly || i)) {
                  ...
                  i = setTimeout(function() {
                    ...
                    if (
                      ...
                      (b.trigger = Y(b) || $(b) || da(b)) &&
                      !W(b, b.trigger.upper || b.trigger.lower)
                        ? b.line.attach().place()
              ...
              a.addCommand("accessPreviousSpace", U(b)),
              a.addCommand("accessNextSpace", U(b, !0)),
              a.setKeystroke([
    ...
    var ca = (function() {
        return function(a, c, d) {
          ...
          c &&
            ...
            e.show());
          return !f ||
            !(f.type == CKEDITOR.NODE_ELEMENT && f.$) ||
            (n.ie &&
              9 > n.version &&
              !a.boundary.equals(f) &&
              !a.boundary.contains(f))
            ? null
            : f;
        };
      })(),
      ...
      da = (function() {
        function a(a) {
          ...
          if (!(a.mouse.y > e.size.top && a.mouse.y < f.size.bottom))
            return null;
          for (
            var b = Number.MAX_VALUE, h, g, j, l;
            f && !f.equals(e) && (g = e.getNext(a.isRelevant));

          )
            (h = Math.abs(ga(a, e, g) - a.mouse.y)),
              h < b && ((b = h), (j = e), (l = g)),
              (e = g),
              o(a, e);
          if (
            !j ||
            !l ||
            !(a.mouse.y > j.size.top && a.mouse.y < l.size.bottom)
          )
            return null;
          i.upper = j;
          i.lower = l;
      ...
      init: function(a) {
        ...
        a.addCommand("pastefromword", {
          ...
          exec: function(a) {
            ...
            a.getClipboardData({ title: a.lang.pastefromword.title }, function(
              c
            ) {
  ...
  (function() {
    ...
    var d = CKEDITOR.plugins.scayt,
      p = function(a, c, b, d, e, f, h) {
        a.addCommand(d, e);
        a.addMenuItem(d, { label: b, command: d, group: f, order: h });
      },
      u = {
        preserveState: !0,
        editorFocus: !1,
      ...
      init: function(a) {
        ...
        c = function(b) {
          ...
          CKEDITOR.env.opera || CKEDITOR.env.air
            ? f.setState(CKEDITOR.TRISTATE_DISABLED)
            : f.setState(
                d.isScaytEnabled(a)
                  ? CKEDITOR.TRISTATE_ON
                  : CKEDITOR.TRISTATE_OFF
  ...
  (function() {
    ...
    var f = (CKEDITOR.plugins.undo.Image = function(a, c) {
        ...
        CKEDITOR.env.ie &&
          d &&
          (d = d.replace(/\s+data-cke-expando=".*?"/g, ""));
        this.contents = d;
        c ||
          (this.bookmarks =
            (d = d && a.getSelection()) && d.createBookmarks2(!0));
    ...
    g.prototype = {
      ...
      update: function(a) {
        if (!this.locked) {
          ...
          for (
            var c = this.index, d = this.snapshots;
            0 < c && this.currentImage.equalsContent(d[c - 1]);
  ...
  CKEDITOR.config.plugins =
    "dialogui,dialog,about,a11yhelp,basicstyles,blockquote,clipboard,card,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc";
