...
!(function(a) {
  ...
  var Renderer = function(a, b, c, d) {
    ...
    toolbar = renderer.create('<div class="note-toolbar card-header"/>'),
    ...
    dropdown = renderer.create('<div class="dropdown-menu shadow">', function(
      a,
      b
    ) {
    ...
    palette = renderer.create('<div class="note-color-palette"/>', function(
      a,
      b
    ) {
