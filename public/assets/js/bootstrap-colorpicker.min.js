!(function(a) {
  ...
  var c = {
      ...
      template:
        '<div class="colorpicker dropdown-menu shadow"><div class="colorpicker-saturation"><i><b></b></i></div><div class="colorpicker-hue"><i></i></div><div class="colorpicker-alpha"><i></i></div><div class="colorpicker-color"><div /></div></div>'
    },
    d = function(d, e) {
  ...
  (d.version = "2.0.0-beta"),
      ...
      mousemove: function(a) {
        ...
        return (
          ...
          this.currentSlider.callLeft &&
            this.color[this.currentSlider.callLeft].call(this.color, b / 100),
          this.currentSlider.callTop &&
            this.color[this.currentSlider.callTop].call(this.color, c / 100),
          this.update(!0),
    ...
    (a.fn.colorpicker = function(b) {
      return this.each(function() {
        var c = a(this),
          e = c.data("colorpicker"),
          f = "object" == typeof b ? b : {};
        e || "string" == typeof b
          ? "string" == typeof b &&
            e[b].apply(e, Array.prototype.slice.call(arguments, 1))
          : c.data("colorpicker", new d(this, f));
      });
    }),
